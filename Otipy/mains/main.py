...
import price_record_manager  # Import the price_record_manager module
...
def main_function(url, category_name, existing_df, inserted_products):
    # Scrape the website
    ...
    for card in otipy_product_cards:
        ...
        # Step 3: Update price records in the price_records_manager
        price_record_manager.update_price_records(product_name, original_price, discounted_price)
...
if __name__ == "__main__":
    ...
    # Initialize the set of inserted products
    ...
    for url, category in categories:
        new_category_products, updated_category_products = main_function(url, category, existing_df, inserted_products)
    ...
    # Step 4: Check for price changes and send notifications
    price_record_manager.check_for_price_changes()
