...
if __name__ == "__main__":
    ...
    # Clean and convert the currency strings to float
    existing_df['Previous Price'] = existing_df['Previous Price'].str.replace('[^\d.]', '', regex=True).astype(float)
    existing_df['New Price'] = existing_df['New Price'].str.replace('[^\d.]', '', regex=True).astype(float)
