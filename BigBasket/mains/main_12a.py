...
# Define categories at the global level
categories = [
...
# Define a function to create a text file for recording price change notifications
def create_price_change_record_file():
    record_file = open(r'D:\Nidhi\Vegease\Otipy\price_change_records.txt', 'w')
    record_file.close()

# Define a function to record a price change in the text file
def record_price_change(product_name, previous_price, new_price):
    with open(r'D:\Nidhi\Vegease\Otipy\price_change_records.txt', 'a') as record_file:
        record_file.write(f"Product: {product_name}\nPrevious Price: {previous_price}\nNew Price: {new_price}\n\n")
        ...
        if product_name not in inserted_products:
            ...
            if previous_price is not None:
                ...
                if previous_price != discounted_price:
                    updated_products.append((product_name, previous_price, discounted_price, discount))
                    record_price_change(product_name, previous_price, discounted_price)
...
if __name__ == "__main__":
    ...
    # Create the Excel file with sheets if it doesn't exist
    if not os.path.isfile(r'D:\Nidhi\Vegease\Otipy\otipy_products.xlsx'):
        create_excel_file(categories)

    # Create the price change record file
    create_price_change_record_file()
    ...
    # Prepare notification messages for new and updated products
        # ... (continuing from the previous part of the code)
    ...
    # Optionally, you can add code here to analyze the price change records in the 'price_change_records.txt' file and plot graphs based on the data.
